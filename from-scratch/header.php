...
<body class="font-[Ubuntu]">
    <div class="max-w-5xl mx-auto px-3 mb-8">
        <div class="flex justify-between items-center py-6 border-b">
            ...
            <ul>
                <li>
                    <a class="px-4" href="index.php">Accueil</a>
                    <a class="px-4" href="livres.php">Livres</a>
                    <a class="px-4" href="cart.php">Panier (<?= count(cart()); ?>)</a>
                    <?php if (user()) { ?>
                    <a class="px-4" href="logout.php"><?= user(); ?></a>
                    <?php } else { ?>
                    <a class="px-4" href="login.php">Connexion</a>
                    <?php } ?>
                </li>
            </ul>
        </div>
