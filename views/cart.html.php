<?php require __DIR__.'/partials/header.html.php'; ?>
    ...
    <div class="max-w-5xl mx-auto px-3">
        ...
        <div class="shadow-lg border rounded-lg p-3">
            ...
            <?php foreach ($cart->items as $item) { ?>
                <div class="flex items-center border-b mb-3 pb-3">
                    ...
                    <a class="bg-red-700 px-4 py-2 text-white inline-block rounded hover:bg-red-500 duration-200 ml-8" href="<?= route('/cart/'.$item['book']->id.'/delete'); ?>">
        ...
        <div class="text-center mt-12">
            <a class="bg-gray-900 px-4 py-2 text-white inline-block rounded hover:bg-gray-700 duration-200" href="<?= route('/'); ?>">
                Commander
            </a>
        </div>
        <?php } ?>
